...
const Sidebar = () => {
    ...
    // This is helpful for hiding sidebar when window size is small.
    // This can enable sidebar to hide whenever clicking an item from the sidebar.
    ...
    // Removed md:hidden for the button style
    return (
                ...
                <>
                    <div className="flex justify-between items-center">
                        <Link to="/" onClick={handleCloseSideBar}
                              ...
                              text-slate-900">
                            <SiMicrogenetics /> <span>Salk</span>
                        </Link>
...
//                             <SiMicrogenetics /> <span>Shoppy</span>
//                         </Link>
