...
const Ecommerce = () => {
    ...
    return (
        ...
        <div className="mt-24">
            ...
            {/*TODO: Change this part into MultiSelect Component https://ej2.syncfusion.com/react/documentation/multi-select/getting-started/ */}
            ...
            <div className="flex gap-10 flex-wrap justify-center">
                <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780  ">
                    ...
                    <div className="mt-10 flex gap-10 flex-wrap justify-center">
                        <div className=" border-r-1 border-color m-4 pr-10">
                            ...
                            {/*TODO: Modify the SparkLine graph into a differnet graph*/}
                            {/*TODO: Change the data passing into the chart*/}
                            <div className="mt-5">
                ...
                <div>
                    ...
                    {/*bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780*/}
                    {/*<div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl md:w-780 p-8 m-3 flex justify-center items-center gap-10">*/}
                    {/*    <div>*/}
